...
describe("Feedback Widget", () => {
  ...
  it("has proper accessibility attributes", () => {
    ...
    cy.get('[data-cy="close-feedback-button"]').should(
      "have.attr",
      "aria-label",
    );
  });
  ...
  it("tracks analytics events", () => {
    ...
    cy.get("@consoleStub").should(
      "have.been.calledWith",
      "Analytics: feedback_open event fired",
    );
    ...
    cy.get("@consoleStub").should(
      "have.been.calledWith",
      "Analytics: feedback_submit event fired (modal closed)",
    );
  });
