...
import { Download, Share2, ExternalLink, RefreshCw, CheckCircle, X } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-bold text-gray-800">Download Your Clip</h3>
          <button
            onClick={onClose}
        ...
        <div className="space-y-3">
          ...
          {downloadComplete ? (
            <div className="text-center py-4">
              ...
              <p className="text-sm text-gray-600">Check your downloads folder</p>
            </div>
          ) : (
            <button
...
export const SharingOptions: React.FC<SharingOptionsProps> = ({
  ...
  const handlePlatformClick = useCallback(async (platform: any) => {
    ...
    <>
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mt-1 truncate max-w-md mx-auto">{videoTitle}</p>
        </div>

        {/* Download Section */}
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-2xl border border-green-200">
          <div className="text-center space-y-3">
            <h4 className="font-semibold text-gray-800 text-lg">Download Your Video</h4>
            <p className="text-gray-600 text-sm">Save the clip to your device</p>
        ...
        <div className="space-y-4">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Share directly to social platforms</p>
          </div>
            ...
            {platforms.map((platform) => (
              ...
              >
                <div className="text-center space-y-2">
                  ...
                  <div>
                    <h5 className="font-medium text-gray-800 text-sm">{platform.name}</h5>
                  ...
                  {sharingPlatform === platform.id ? (
                    ...
                    <div className={`bg-gradient-to-r ${platform.color} text-white py-1 px-3 rounded-lg text-xs font-medium flex items-center justify-center space-x-1`}>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200">
          ...
          >
            <RefreshCw className={`w-4 h-4 ${deleteClipMutation.isPending ? 'animate-spin' : ''}`} />
