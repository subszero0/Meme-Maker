...
async def get_rate_limit_status(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Rate limit status retrieval failed")
...
async def get_storage_info() -> Dict[str, Any]:
    ...
    try:
        ...
        available_backends = [backend.value for backend in StorageFactory.list_available_backends()]
