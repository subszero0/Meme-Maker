...
class TestMetadataCache:
    ...
    async def test_invalidate_url(self, cache, mock_redis):
        ...
        mock_redis.keys.return_value = [b"cache:metadata:abc123", b"cache:format:abc123"]
...
class TestStorageFactory:
    ...
    def test_get_default_storage(self):
        ...
        with patch('backend.app.factories.storage_factory.get_settings') as mock_settings:
...
class TestPhase3Integration:
    ...
    async def test_cache_and_cleanup_integration(self):
        ...
        with patch.object(cleanup, 'cleanup_expired_jobs', return_value={'jobs_deleted': 0}):
